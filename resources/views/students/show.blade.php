...
<h2 class="text-2xl font-bold mb-6">Student Personal Details</h2>
...
<div>
<span class="font-semibold">PF Number :</span>
<span>{{ $student->pf_number }}</span>
</div>

<div>
<span class="font-semibold">UAN Number :</span>
<span>{{ $student->uan_number }}</span>
</div>

<div>
<span class="font-semibold">ESI Number :</span>
<span>{{ $student->esi_number }}</span>
</div>
...
<div>
<span class="font-semibold">Contact Pincode :</span>
<span>{{ $student->contact_pincode }}</span>
</div>
...
<div>
<span class="font-semibold">Permanent Pincode :</span>
<span>{{ $student->permanent_pincode }}</span>
</div>
...
<div
onclick="viewFile('{{ asset('uploads/images/'.$f) }}','{{ in_array($ext,['jpg','jpeg','png','gif']) ? 'img' : 'pdf' }}')"
